 ...
 *
 * Purpose: Adapter class to convert Requests (model objects) to List view items
 * Displays all the friend requests that you have, as well as the option to accept/reject them.
 */
