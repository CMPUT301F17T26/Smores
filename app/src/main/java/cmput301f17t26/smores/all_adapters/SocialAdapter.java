...
public class SocialAdapter extends RecyclerView.Adapter<SocialAdapter.ViewHolder> {
    ...
    public SocialAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText("Following person " + mValues.get(position).content);
