 ...
 *
 * Purpose: Represents a pair model that holds habit OR habit events for synchronizing with the server.
 * Also holds the command to be done (e.g. add, edit, delete).
 */
